...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { confirmed: @attendance.confirmed, event_id: @attendance.event_id, user_id: @attendance.user_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { confirmed: @attendance.confirmed, event_id: @attendance.event_id, user_id: @attendance.user_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
